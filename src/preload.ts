...
contextBridge.exposeInMainWorld("electronAPIs", {
    user_list: () => ipcRenderer.invoke("/user/get"),
    user_get: (id: string) => ipcRenderer.invoke("/user", { id }),
    ...
    action_open_browser: (id: string) => ipcRenderer.invoke("/action/open_browser", { id }),
